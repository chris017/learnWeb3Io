...
contract CSArt is ERC721Enumerable, Ownable {
    ...
    /**
        ...
        */
    constructor (string memory baseURI) ERC721("CSArt", "CSA") Ownable(msg.sender) {
    ...
    */
    function mint() public payable onlyWhenNotPaused {
        require(tokenIds < maxTokenIds, "Exceed maximum CSArt supply");
