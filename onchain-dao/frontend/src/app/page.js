 ...
 async function createProposal() {
  ...
  return (
    <div className={inter.className}>
      ...
      {!isConnected ? (
        <div>
          <Suspense fallback={<div>Loading Connect Button...</div>}>
            <ConnectButton />
          </Suspense>
        </div>
      ) : (
        <div className={styles.main}>
          <div>
            ...
            <div className={styles.description}>
              ...
              {numOfProposalsInDAO.isFetched && numOfProposalsInDAO.data ? 
                numOfProposalsInDAO.data.toString() : "Loading..."}
            </div>
            <div className={styles.flex}>
            ...
            {renderTabs()}
            {/* Display withdraw button if connected wallet is owner */}
